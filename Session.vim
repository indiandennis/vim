...
set laststatus=2
set ruler
set runtimepath=~/.vim,~/.vim/bundle/colorschemes,~/.vim/bundle/gundo,~/.vim/bundle/lightline.vim,~/.vim/bundle/vim-colors-solarized,~/.vim/bundle/vim-fugitive,~/.vim/bundle/vim-git,~/.vim/bundle/vim-solarized8,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/after
set showcmd
set showmatch
